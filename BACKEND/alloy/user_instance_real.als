...
// 1. Zone (망 영역) 정의
// ---------------------------------------------------------
one sig LocationDefault extends Location {}
fact { LocationDefault.grade = Open and LocationDefault.type = Internet }
...
fact {
    System1.grade = Open
    System1.loc = LocationDefault
    System1.type = Server
    System1.authType = Single
    System1.isCDS = False
    System1.isRegistered = False
    System1.stores = none
}
